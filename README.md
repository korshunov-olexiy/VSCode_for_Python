...
<tr><th colspan="2" style="text-align:center">Плагины для VSCode</th></tr>
  ...
  <tr><td><code>Django</code><br><code>(Baptiste Darthenay)</code></td><td><img src="media/django_extension.png" width=70%><br>Имеет полезные подсказки: <img src="media/django_extension_working.png"></td></tr>
